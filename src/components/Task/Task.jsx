    ...
    className='task w-full text-white flex flex-row justify-between rounded-md p-5'>
      ...
      <div className='task-info w-8/12'>
        ...
        <div className='task-tags text-sm flex flex-row gap-1'>
          <p className='task-tag h-fit text-red-300 bg-red-800 p-1 rounded-md'>Work</p>
          <p className='task-tag h-fit text-violet-300 bg-violet-800 p-1 rounded-md'>My Project</p>
        </div>
      </div>
      <div className='continue-track flex flex-col gap-3'>
        <p>00:32:10</p>
        <button className='self-end'><img src="src/assets/play.svg" alt="" /></button>
      </div>
    </motion.div>
  );
}
