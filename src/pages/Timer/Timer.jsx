...
const Timer = () => {
  ...
  function renderPauseButton() {
    if (started) {
      return <img src={process.env.PUBLIC_URL + "/assets/pause.svg"} alt="" />;
    } else {
      return <img src={process.env.PUBLIC_URL + "/assets/play.svg"} alt="" />;
    }
  }
      ...
      >
        ...
        <section className="buttons flex flex-row justify-evenly">
          ...
          <motion.button
            ...
            onClick={handleStop}
          >
            <img src={process.env.PUBLIC_URL + "/assets/stop.svg"} alt="" />
          </motion.button>
        </section>
      </section>
    </section>
